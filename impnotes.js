...
//    are functions that execute before or after specific database operations within the Mongoose library,
//    which is used for interacting with MongoDB in Node.js applications.

//    jwt [A JWT (JSON Web Token) is a specific type of bearer token]

//    multer
//    The main use of Multer is to handle file uploads from an HTML form that includes a file input field


// index.js file is tara se likh sakta hu
// (async () => {
//     try {
